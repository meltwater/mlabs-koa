...
export default (dependencies, config) => {
  ...
  return {
    ...
    shutdownOnChange: shutdownOnChange || defaultShutdownOnChange,
    shutdownDelay: shutdownDelay || defaultShutdownDelay,
    exitOnFalseStart: exitOnFalseStart || defaultExitOnFalseStart
  }
}
