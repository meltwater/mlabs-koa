...
import { defaultTo, isNil, isNotObj, isNotString } from '@meltwater/phi'
...
const createBootstrap = (
  ...
  try {
    ...
    const log = createLogger({
      ...(config.get('env:development') ? {} : logMeta),
      ...logConfig,
...
export default (
  ...
  try {
    ...
    const bootstrap = createBootstrap(createDependencies, startServer, watcher)
